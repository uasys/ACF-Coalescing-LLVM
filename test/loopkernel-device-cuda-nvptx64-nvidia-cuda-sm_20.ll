...
if.end:                                           ; preds = %if.then, %entry
  ...
  %mul = mul i32 2, %8, !dbg !515
  %idxprom9 = zext i32 %mul to i64, !dbg !516
  %9 = load i32*, i32** %b.addr, align 8, !dbg !516
  %arrayidx10 = getelementptr inbounds i32, i32* %9, i64 %idxprom9, !dbg !516
  %10 = load i32, i32* %arrayidx10, align 4, !dbg !516
  %11 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #2, !dbg !517, !range !496
  %idxprom12 = zext i32 %11 to i64, !dbg !519
  %12 = load i32*, i32** %a.addr, align 8, !dbg !519
  %arrayidx13 = getelementptr inbounds i32, i32* %12, i64 %idxprom12, !dbg !519
  store i32 %10, i32* %arrayidx13, align 4, !dbg !520
  %13 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #2, !dbg !521, !range !496
  %rem = urem i32 %13, 2, !dbg !524
  %cmp15 = icmp eq i32 %rem, 0, !dbg !525
  br i1 %cmp15, label %if.then16, label %if.end20, !dbg !526

if.then16:                                        ; preds = %if.end
  %14 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #2, !dbg !527, !range !496
  %idxprom18 = zext i32 %14 to i64, !dbg !530
  %15 = load i32*, i32** %a.addr, align 8, !dbg !530
  %arrayidx19 = getelementptr inbounds i32, i32* %15, i64 %idxprom18, !dbg !530
  store i32 0, i32* %arrayidx19, align 4, !dbg !531
...
!472 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/taylor/git/coalescingsa-llvm/test")
!473 = !{!474, !475, !476}
...
!514 = distinct !DILocation(line: 8, column: 26, scope: !450)
!515 = !DILocation(line: 8, column: 25, scope: !450)
!516 = !DILocation(line: 8, column: 22, scope: !450)
!517 = !DILocation(line: 67, column: 3, scope: !459, inlinedAt: !518)
!518 = distinct !DILocation(line: 8, column: 7, scope: !510)
!519 = !DILocation(line: 8, column: 5, scope: !450)
!520 = !DILocation(line: 8, column: 20, scope: !450)
!521 = !DILocation(line: 67, column: 3, scope: !459, inlinedAt: !522)
!522 = distinct !DILocation(line: 9, column: 8, scope: !523)
!523 = distinct !DILexicalBlock(scope: !450, file: !1, line: 9, column: 8)
!524 = !DILocation(line: 9, column: 19, scope: !523)
!525 = !DILocation(line: 9, column: 22, scope: !523)
!526 = !DILocation(line: 9, column: 8, scope: !450)
!527 = !DILocation(line: 67, column: 3, scope: !459, inlinedAt: !528)
!528 = distinct !DILocation(line: 10, column: 11, scope: !529)
!529 = distinct !DILexicalBlock(scope: !523, file: !1, line: 9, column: 28)
!530 = !DILocation(line: 10, column: 9, scope: !529)
!531 = !DILocation(line: 10, column: 24, scope: !529)
!532 = !DILocation(line: 11, column: 5, scope: !529)
!533 = !DILocation(line: 12, column: 1, scope: !450)
