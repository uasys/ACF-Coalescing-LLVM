...
entry:
  ...
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #2, !dbg !458, !range !495
  %idxprom = zext i32 %0 to i64, !dbg !496
  %1 = load i32*, i32** %b.addr, align 8, !dbg !496
  %arrayidx = getelementptr inbounds i32, i32* %1, i64 %idxprom, !dbg !496
  %2 = load i32, i32* %arrayidx, align 4, !dbg !496
  %3 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #2, !dbg !497, !range !495
  %idxprom2 = zext i32 %3 to i64, !dbg !500
  %4 = load i32*, i32** %a.addr, align 8, !dbg !500
  %arrayidx3 = getelementptr inbounds i32, i32* %4, i64 %idxprom2, !dbg !500
  store i32 %2, i32* %arrayidx3, align 4, !dbg !501
  ret void, !dbg !502
}
...
!472 = !DIFile(filename: "/usr/include/vector_types.h", directory: "/home/taylor/git/coalescingsa-llvm/test")
!473 = !{!474, !475, !476}
...
!494 = distinct !DILocation(line: 4, column: 24, scope: !450)
!495 = !{i32 0, i32 1024}
!496 = !DILocation(line: 4, column: 22, scope: !450)
!497 = !DILocation(line: 67, column: 3, scope: !459, inlinedAt: !498)
!498 = distinct !DILocation(line: 4, column: 7, scope: !499)
!499 = !DILexicalBlockFile(scope: !450, file: !1, discriminator: 1)
!500 = !DILocation(line: 4, column: 5, scope: !450)
!501 = !DILocation(line: 4, column: 20, scope: !450)
!502 = !DILocation(line: 5, column: 1, scope: !450)
